...
import { ColorSchemeT, Rey, Ren } from 'constants/ColorSchemes'

class Sketch extends SketchClass {
  points: PointCartesian[] = []
  theme: ColorSchemeT = Ren
  ...
  draw = () => {
    ...
    this.circle(c1.x, c1.y, c1.r, theme.secondary)
    this.circle(c2.x, c2.y, c2.r, theme.secondary)
    ...
    this.dot(CW/2 + v2x, CH/2 + v1y, 6, theme.accent)
    ...
    this.dot(c1.x + v1x, c1.y + v1y, 6, theme.secondary)
    this.dot(c2.x + v2x, c2.y + v2y, 6, theme.secondary)
